...
#define EXTCON_DEV_NAME		EXTCON_SEC_NAME
...
struct sec_battery_info {
...
#if defined(CONFIG_EXTCON)
	struct sec_battery_extcon_cable extcon_cable_list[CABLE_END];
#endif /* CONFIG_EXTCON */
	...
	/* Extcon delayed workqueue*/
	struct workqueue_struct *extcon_wqueue;
