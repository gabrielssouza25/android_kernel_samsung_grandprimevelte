...
#define PM88X_WD_TIMER_ACT_MASK 	(7 << 3)
#define PM88X_WD_TIMER_ACT_1S		(0 << 3)
#define PM88X_WD_TIMER_ACT_4S		(2 << 3)

#define PM88X_FAULT_WU_EN		(1 << 2)
#define PM88X_FAULT_WU			(1 << 3)
